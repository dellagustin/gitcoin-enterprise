...
export class AuthenticationService {
    ...
    public getOAUTHLoginURL(): string {
        ...
        // return `${config.gitHubURL}/login/oauth/authorize?client_id=${config.gitHubOAuthClient}&scope=read:user&redirect_uri=${config.backendURL}/authentication/github/callback&state=${state}`
    }
